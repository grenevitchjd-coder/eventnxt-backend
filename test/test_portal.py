# eventnxt-backend: test/test_portal.py  (verification harness)
#
...
#      are best-effort)
#
# Run: DATABASE_URL="postgresql://test@/eventnxt_test?host=/tmp&port=5433" python3 test/test_portal.py
import os
import sys
