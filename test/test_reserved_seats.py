# eventnxt-backend: test/test_reserved_seats.py  (verification harness)
#
...
#
# Run: DATABASE_URL="postgresql://test@/eventnxt_test?host=/tmp&port=5433" python3 test/test_reserved_seats.py
import os
import sys
