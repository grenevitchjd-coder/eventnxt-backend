# eventnxt-backend: test/test_adjust.py  (verification harness)
#
...
#      without SMTP
#
# Run: DATABASE_URL="postgresql://test@/eventnxt_test?host=/tmp&port=5433" python3 test/test_adjust.py
import os
import sys
