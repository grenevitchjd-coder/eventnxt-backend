# eventnxt-backend: test_multiday.py  (verification harness — repo root)
#
...
#
# Run: DATABASE_URL="postgresql://test@/eventnxt_test?host=/tmp&port=5433" python3 test_multiday.py
import os
import uuid
