...
def upsert_profile(
    ...
    if profile:
        ...
        profile.font_family = payload.font_family
        profile.logo_position = payload.logo_position
        profile.banner_focus = payload.banner_focus
        profile.about_us = payload.about_us
        profile.slug = slug
        ...
        profile = EventProfile(
            ...
            banner_focus=payload.banner_focus,
...
def get_public_event_profile(slug: str, db: Session = Depends(get_db)):
    ...
    return PublicEventProfileResponse(
        ...
        banner_focus=profile.banner_focus,
